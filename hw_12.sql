...
insert into builder(position, salary) values('Builder №1', 10000),('Builder №2', 15000), ('Builder №3', 20000),('Taskmaster №1', 60000),('Taskmaster №2', 100000);
